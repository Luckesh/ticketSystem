...
if ($result->num_rows > 0) {
  echo "<h2>Vaše hlásenia</h2>";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo '<button class="solveBtn" onclick=displaySolveModal('.$row["IDticket"].')>&#x2714</button>';
      echo '</div>';
      echo '<div class="lowerBoxIcon">';
      echo '<p class="tip">Kontakt:</p>';
      echo '<button class="mailBtn" onclick="displayMailModal('.$row["IDticket"].')"></button>';
      echo '</div>';
      echo '</div>';
